...
public class ADS {
    ...
    public static void tempoLivre(List<Double> tempoFinalServRelogio,List<Double> tempoCltSist, List<Double> tempoCltFila, List<Double> tempoLivreOp) {

        tempoLivreOp.add(tempoFinalServRelogio.get(0) - tempoCltSist.get(0));

        for (int i = 1; i < numeroDePacote; ++i) {

            tempoLivreOp.add((tempoFinalServRelogio.get(i) + tempoCltFila.get(i))
    ...
    public static void comecar(List<Double> tempoUltCh, List<Double> tempoServ,
        ...
        tempoLivre(tempoFinalServRelogio, tempoCltSist, tempoCltFila, tempoLivreOp);//9)Tempo livre do servidor do roteador ou tempo que o servidor do roteador ficou ocupado (microssegundos) 
